package com.tenpo.fee.controller.advice;

import com.tenpo.fee.constant.ProblemType;
import com.tenpo.fee.dto.Problem;
import com.tenpo.fee.exception.ResourceNotFoundException;
...
public class FeeRestControllerAdvice {

    Logger logger = LoggerFactory.getLogger(FeeRestControllerAdvice.class);
